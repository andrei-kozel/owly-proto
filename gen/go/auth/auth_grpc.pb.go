...
const (
	AuthService_GetAuthURL_FullMethodName    = "/auth.AuthService/GetAuthURL"
	AuthService_ExchangeCode_FullMethodName  = "/auth.AuthService/ExchangeCode"
	AuthService_ValidateState_FullMethodName = "/auth.AuthService/ValidateState"
)
...
type AuthServiceClient interface {
	...
	ValidateState(ctx context.Context, in *ValidateStateRequest, opts ...grpc.CallOption) (*ValidateStateResponse, error)
}
...
func (c *authServiceClient) ValidateState(ctx context.Context, in *ValidateStateRequest, opts ...grpc.CallOption) (*ValidateStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidateStateResponse)
	err := c.cc.Invoke(ctx, AuthService_ValidateState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	ValidateState(context.Context, *ValidateStateRequest) (*ValidateStateResponse, error)
...
func (UnimplementedAuthServiceServer) ValidateState(context.Context, *ValidateStateRequest) (*ValidateStateResponse, error) {
...
func _AuthService_ValidateState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).ValidateState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_ValidateState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ValidateState(ctx, req.(*ValidateStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_ValidateState_Handler,
		},
	},
